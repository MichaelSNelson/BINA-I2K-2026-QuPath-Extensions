...
> tables; the *synth multiplex project* is a ready-to-open QuPath project built from it, with
> cells already detected and a trained classifier. If you want both, take both — together they
> are under 35 MB.
